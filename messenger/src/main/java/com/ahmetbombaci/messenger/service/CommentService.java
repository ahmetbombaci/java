...
import com.ahmetbombaci.messenger.model.Comment;
import com.ahmetbombaci.messenger.model.ErrorMessage;
...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		...
		if(comment == null)
			throw new NotFoundException(response); //child class of WebApplicationException
		return comment;
	}
